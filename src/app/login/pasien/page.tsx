  ...
  const handleLogin = async (
    ...
    try {
      ...
      const response = await fetch(
        "https://backend-prima.vercel.app/auth/login/pasien",
        {
          method: "POST",
          headers: {
            "Content-Type":
      ...
      // nanti tinggal simpan token di sini
      // localStorage.setItem("token", result.token)

      // nanti redirect/dashboard di sini
    } catch (err: unknown) {
            ...
            >
              ...
              <div className="relative my-10">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-[#F0EAE0]" />
                </div>
